...
### ✅ docker-01
Primary Docker host — 8 containers, see the **Docker Containers** section. Runs on Ubuntu 26.04, all containers on the `macvlan-net` network with static IPs on `192.168.100.0/24`.  
