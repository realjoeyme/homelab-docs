...
Small-form-factor desktop with **12th gen Intel Core i5-12500T** (Alder Lake, 6 cores / 12 threads), **64GB DDR4**, and dual storage: 1TB WD Blue SN580 NVMe (Proxmox + `local-lvm` for all VM disks) and 512GB Samsung 850 PRO SATA (second-site backup, see Storage). Runs Proxmox VE 9.2.3.
