...
### ✅ Proxmox VE
Primary compute runs on a single **Dell Optiplex 3000.**  
Since April, I downsized from a complex 3-node topology (2-node cluster + 1 standalone) to this single host.  
