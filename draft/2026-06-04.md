...
The hypervisor — small-form-factor desktop with **12th gen Intel Core i5-12500T** (Alder Lake, 6 cores / 12 threads), **64GB DDR4**, and dual storage: 1TB WD Blue SN580 NVMe (Proxmox + `local-lvm` for all VM disks) and 512GB Samsung 850 PRO SATA (second-site backup, see Storage). Runs Proxmox VE 9.2.3.
...
| <img src="https://cdn.simpleicons.org/ubuntu/E95420" width="20" height="20" alt="Ubuntu"> | `hermes` | 101 | Ubuntu 26.04 LTS | 192.168.100.101 | 4GB | Hermes AI agent VM |
...
| <img src="https://cdn.jsdelivr.net/gh/selfhst/icons@main/svg/microsoft-windows.svg" width="20" height="20" alt="Windows Server"> | `w01-dhcp` | 104 | Windows Server 2022 | 192.168.100.66 | 4GB | AD / DHCP / DNS / NTP |
