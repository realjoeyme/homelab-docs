...
powersave
```
The Dell OptiPlex 3000, running Proxmox VE 9.2.3, draws only around 8W during normal operation.  

![ProxMenux Dashboard](powerdraw.png)  
...
It offers at-a-glance visibility into:

- Node health and system vitals  
- Hardware temperatures  
- Active VM and container states  
