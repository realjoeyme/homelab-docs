...
A second Synology DSM instance, **virtualized** as a Proxmox VM (`vmid 102`, 4GB RAM) rather than running on bare metal. IP `192.168.100.26`.
...
- **Resources:** ~200MB RAM, negligible CPU
